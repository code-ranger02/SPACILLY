...
- **Frontend:** `VITE_API_URL`, `VITE_SERVER_URL` (build-time on S3/Amplify/CloudFront).
- **Backend:** Set via AWS Elastic Beanstalk Environment properties — see `deploy/aws/environment.properties.example`.
